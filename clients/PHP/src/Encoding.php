...
class Encoding
{
	...
	{
		/**
		 * Function \Helper\Encoding::toUTF8.
		 *
	...
	protected static function utf8_decode($text, $option)
	{
		if ($option == self::WITHOUT_ICONV || !function_exists('iconv')) {
			$o = str_replace(array_keys(self::$utf8ToWin1252), array_values(self::$utf8ToWin1252), self::toUTF8($text));
			$o = mb_convert_encoding($o, 'ISO-8859-1', 'UTF-8');
		} else {
